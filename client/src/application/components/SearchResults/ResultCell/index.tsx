...
import { AlbumResult, ArtistResult, AudioBookResult, AutoItem, EpisodeResult, PlaylistResult, ResultItem, ShowResult, TrackResult } from "../../common.types"
 ...
 * @returns 
 */
export const ResultCell: FC<{item?: AutoItem}> = ({item}) => {
	switch (item?.type) {
